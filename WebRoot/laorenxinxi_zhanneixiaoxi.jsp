...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#F3F3F3" class="table table-striped table-bordered table-hover">  
  ...
  %>>
    ...
    <td width="60" height="50" align="center"><a class="btn btn-info btn-small" href='zhanneixiaoxi_add.jsp?id=<%=map.get("id")%>'>添加站内消息</a> <a class="btn btn-info btn-small" href="laorenxinxidetail.jsp?id=<%=map.get("id")%>" target="_blank"> <i class="glyphicon glyphicon-random" > </i> 详细</a> </td>
  </tr>
  	<%
  }
   %>
