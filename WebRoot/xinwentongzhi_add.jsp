 ...
 <form  action="xinwentongzhi_add.jsp?f=f"  method="post" name="f1"  onsubmit="return checkform();">
  ...
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#cccccc" >
	...
	<tr><td>类别：</td>
	  <td><input name="leibie" type="text" id="leibie" value="<%=lb%>" class="form-control" readonly='readonly'>	    <input name="lb" type="hidden" id="lb" value="<%=lb%>">	 
      &nbsp;* </td>
	</tr>
	<tr><td>内容：</td><td><textarea name="neirong" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;"></textarea></td></tr>
	<tr><td>添加人：</td><td><input name='tianjiaren' type='text' id='tianjiaren' class="form-control" value='<%=request.getSession().getAttribute("username")%>' readonly='readonly' /><div style="margin-top:16px;">&nbsp;*</div></td></tr>
	...
	<tr><td>点击率：</td><td><input name='dianjilv' type='text' id='dianjilv' value='0' class="form-control"  readonly='readonly'/><div style="margin-top:16px;">&nbsp;*</div></td></tr>
    <tr>
      <td height="45">&nbsp;</td>
